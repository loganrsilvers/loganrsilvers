...
```yaml
name: "Your Name"
role: "Software Engineer / Your Title"
location: "City, Country"
currently_building: "Something cool"
currently_learning: "Rust / Distributed Systems / whatever's true"
fun_fact: "Compiles code faster than coffee brews"
...
![React](https://img.shields.io/badge/-React-00FF41?style=flat-square&logo=react&logoColor=000)
![Node.js](https://img.shields.io/badge/-Node.js-00FF41?style=flat-square&logo=node.js&logoColor=000)
...
![Linux](https://img.shields.io/badge/-Linux-00FF41?style=flat-square&logo=linux&logoColor=000)
![Git](https://img.shields.io/badge/-Git-00FF41?style=flat-square&logo=git&logoColor=000)

<sub>swap these for whatever's actually true — badge list: https://github.com/Ileriayo/markdown-badges</sub>
...
### `$ python snake_game.py --contributions`

<div align="center">

<!--
  This animation is generated by a GitHub Action (see snake.yml in this download).
